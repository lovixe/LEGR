...
/*
class SeismicPropagationLossModel : public PropagationLossModel
{
  public:
    static TypeId GetTypeId(void);
    SeismicPropagationLossModel();
  private:
    SeismicPropagationLossModel(const SeismicPropagationLossModel&);
    SeismicPropagationLossModel& operator= (const SeismicPropagationLossModel&);
    virtual double DoCalcRxPower (double txPowerDbm,
                                Ptr<MobilityModel> a,
                                Ptr<MobilityModel> b) const;
    virtual int64_t DoAssignStreams (int64_t stream);
