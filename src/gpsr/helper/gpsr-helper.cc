...
LegrHelper*
LegrHelper::Copy (void) const
{
  return new LegrHelper (*this);
}

Ptr<Ipv4RoutingProtocol>
LegrHelper::Create (Ptr<Node> node) const
{
...
void
LegrHelper::Set (std::string name, const AttributeValue &value)
{
